...
public class QueryUserInfs_v2ReqData extends BaseReqdata{

	private String ver;//文档版本号
	private String mchnt_txn_dt;//交易日期
	private String user_ids;//待查询的登录帐户列表-M
	private String user_idNos;//待查询的登录省份证列表-M
	private String user_bankCards;//待查询的登录银行卡列表-M
