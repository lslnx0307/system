...
public class UmengConfig {
	private static String appkey = "58f57fa3aed17946af002132";
	private static String appMasterSecret = "0l8byfzqsudscvptd1vhqhzjj6zfibsv";
	private static String timestamp = null;
	private static boolean productionMode = false ;//false 测试true 生产
	...
	public  static void sendAndroidUnicast() throws Exception {
		...
		unicast.setTicker( "聚胜财富欢迎您");
		unicast.setTitle(  "聚胜财富-邀请好友三重礼");
		unicast.setText(   "聚胜财富:邀请好友三重礼正在进行中...");
