...
public class JSpush {  
    ...
    public static final String TITLE = "聚胜财富";  
    public static final String ALERT = "祝大家新春快乐";  
    public static final String MSG_CONTENT = "聚胜财富祝新老客户新春快乐";  
...
//    	PushPayload payload = PushPayload.alertAll("聚胜财富-邀请好有投资享最高2%返现");
//    	
//    	pushMessageAll(payload);
//   	timedPushMessageAll("聚胜财富", "2017-03-10 15:42:00", payload);
//    	timedPushMessageAll("聚胜财富", "2017-03-10 15:50:00", payload);
//    	
    	testGetScheduleList();
