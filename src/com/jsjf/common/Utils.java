	...
	public static void trimMapStrng(Map<String, Object>map){
		if(map != null){
			...
			for(Entry<String, Object> ds:entrySet){
				if(ds.getValue() == null){
					map.put(ds.getKey(), null);
				}else if(ds.getValue().getClass() == String.class){
				   //去掉String字符串的前后空格
...
//	}
    ...
    */
	...
	public static String platformSource(Integer value) {
		if (value == 0) {
			return "pc";
		}else if (value == 1) {
			return "ios";
	...
	public static String repayType(Integer value) {
		if (value == 1) {
			return "到期一次还本付息";
		}else if (value == 2) {
			return "按月付息到期还本";
