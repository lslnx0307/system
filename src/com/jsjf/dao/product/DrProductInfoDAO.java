...
public interface DrProductInfoDAO {
	...
	public DrProductInfo getDrProductLoanByMchntTxnSsn(Map<String,Object> map);
 	 ...
 	 * @return
 	 */
 	public Map<String, Object> getDepositReturnLoanListSum(Map<String, Object> map);
	 ...
	 * @return
	 */
	public List<Map<String, Object>> getInstallmentRepaymentProductInfo(Integer id);
	 ...
	 * @return
	 */
	public DrProductInfo getProductInfoBySid(@Param("sid")Integer sid);
}