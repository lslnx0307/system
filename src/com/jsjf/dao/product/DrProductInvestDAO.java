...
public interface DrProductInvestDAO {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> selectActivityBudget(Map<String,Object> param);
	/**
	 * 总计
	 * @param map
	 * @return
	 */
	public Map<String,Object> selectActivityBudgetSum(Map<String,Object> map);
	/**
	 * 本页统计
	 */
	public List<Map<String,Object>> selectActivityBudgetSumByPage(Map<String,Object> map);
	/**
	 * 获取平台贴息明细count
	 * @param param
	 * @return
	 */
	public Integer selectActivityBudgetCount(Map<String,Object> param);
	 ...
	 * @return
	 */
	public List<Map<String,Object>> selectSemInvestList(Map<String,Object> param);
	/**
	 * sem新规则 订单查询count
	 * @param param
	 * @return
	 */
	public int selectSemInvestListCount(Map<String,Object> param);
	
	/**
	 * sem新规则 订单查询 合计 注册人数（姓名列下面）、绑卡人数（绑卡银行列下面）、订单金额（订单金额列下面）、预计收益（预计收益列下面）、红包返现（红包返现列下面
	 * @param param
	 * @return
	 */
	public List<Map<String,Object>> selectSemInvestListAggregate(Map<String,Object> param);
	/**
	 * 根据条件查询流失找回的用户
	 * @param param
	 * @return
	 */
	public List<Map<String,Object>> selectCustomerLossByMap(Map<String,Object> param);
	/**
	 * 获取双12要返现的人
	 * @return
	 */
	public List<Map<String,Object>> getDouble12CashBackUid(Map<String,Object> map);
	/**
	 * 双12阵营排行榜
	 * @return
	 */
	public List<Map<String,Object>> getTeamInvestTop(Map<String,Object> map);
}
