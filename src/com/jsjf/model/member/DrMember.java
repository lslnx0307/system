...
public class DrMember implements Serializable{
	...
	private Integer mgid;//会员等级
	private Integer wealth;//财富值
	private Integer whether;//是否弹框提示会员系统上线（1-提示 2-不提示）
	private Integer isMember;//是否点亮会员1-是 2-否
	private String levelName;//会员等级
	private String initLevel;//会员等级
	private BigDecimal newAmount;//新投资总额
	private BigDecimal surplusAmount;//剩余投资总额
