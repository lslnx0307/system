...
public class DrFeedback  implements Serializable{
	...
	public String toString() {
		return "DrFeedback [id=" + id + ", uid=" + uid + ", contactInformation=" + contactInformation + ", content="
				+ content + ", feedbackTime=" + feedbackTime + ", handleResult=" + handleResult + ", handleTime="
				+ handleTime + ", handleId=" + handleId + ", status=" + status + ", statusName=" + statusName
				+ ", realName=" + realName + ", mobilePhone=" + mobilePhone + ", recommCodes=" + recommCodes
				+ ", wealth=" + wealth + ", level=" + level + "]";
	}
