...
public class DrClaimsLoan{
    ...
    private String loanDeadline;//（原贷款期限(天)）(现融资顾问期限 8.28)
	...
	private Date creditDate;//融资顾问开始时间 
	private Date overDate;//融资顾问开始时间 
	private Integer financingDeadline;//融资顾问期限
	private Integer borrowing_type;//债权类型（1-企业借款 2-个人借款）
	...
	private Integer claimsOriginate; //债权来源（1-聚胜财富，2-代收付）
	...
	public String toString() {
		return "DrClaimsLoan [id=" + id + ", name=" + name + ", no=" + no + ", companyNameProtocolShow="
				+ companyNameProtocolShow + ", status=" + status + ", loanUse=" + loanUse + ", loanAmount=" + loanAmount
				+ ", receiveInterest=" + receiveInterest + ", serviceCharge=" + serviceCharge + ", currency=" + currency
				+ ", loanDeadline=" + loanDeadline + ", rate=" + rate + ", repayType=" + repayType + ", repayDeadline="
				+ repayDeadline + ", startDate=" + startDate + ", endDate=" + endDate + ", dateType=" + dateType
				+ ", loanName=" + loanName + ", bankName=" + bankName + ", bankNo=" + bankNo + ", advisoryRate="
				+ advisoryRate + ", serviceRate=" + serviceRate + ", defaultersRate=" + defaultersRate
				+ ", overdueRate=" + overdueRate + ", overduePenaltyRate=" + overduePenaltyRate + ", riskRate="
				+ riskRate + ", addDate=" + addDate + ", addUser=" + addUser + ", updDate=" + updDate + ", updUser="
				+ updUser + ", cardFlag=" + cardFlag + ", isAuditEdit=" + isAuditEdit + ", companyName=" + companyName
				+ ", dueStartDate=" + dueStartDate + ", dueEndDate=" + dueEndDate + ", pendRepayAmount="
				+ pendRepayAmount + ", productCounts=" + productCounts + ", surplusAmount=" + surplusAmount + ", code="
				+ code + ", drClaimsBill=" + drClaimsBill + ", drClaimsCustomer=" + drClaimsCustomer
				+ ", drClaimsFinanc=" + drClaimsFinanc + ", drClaimsGuarantee=" + Arrays.toString(drClaimsGuarantee)
				+ ", drClaimsShareholder=" + Arrays.toString(drClaimsShareholder) + ", drClaimsPic=" + drClaimsPic
				+ ", drClaimsProject=" + drClaimsProject + ", bankAddress=" + bankAddress + ", statusName=" + statusName
				+ ", customerId=" + customerId + ", user_id=" + user_id + ", fuiou_acnt=" + fuiou_acnt
				+ ", mchnt_txn_ssn=" + mchnt_txn_ssn + ", creditDate=" + creditDate + ", overDate=" + overDate
				+ ", financingDeadline=" + financingDeadline + ", borrowing_type=" + borrowing_type + ", payLoanNo="
				+ payLoanNo + ", claimsOriginate=" + claimsOriginate + ", showStatus=" + showStatus + "]";
	}
