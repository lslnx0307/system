...
public class DrClaimsCustomer{
    ...
    private String loanUse;//贷款项目基本信息
    private String bankNo;//银行卡号
	private String tableName = "dr_claims_customer";//表名
	
	private BigDecimal registerMoney;//注册资金
	private Integer isExistence;//是否存续
	private Integer operatingPeriod;//经营期限
    ...
    private String bank_perm_no; //开户银行许可证
    private String ins_cer_no; //机构信用代码证
    
    private Integer updataIdAndAcnt; 
	...
	public Integer getUpdataIdAndAcnt() {
		return updataIdAndAcnt;
	}

	public void setUpdataIdAndAcnt(Integer updataIdAndAcnt) {
		this.updataIdAndAcnt = updataIdAndAcnt;
	}

	public String getBank_perm_no() {
		return bank_perm_no;
	}

	public void setBank_perm_no(String bank_perm_no) {
		this.bank_perm_no = bank_perm_no;
	}

	public String getIns_cer_no() {
		return ins_cer_no;
	}

	public void setIns_cer_no(String ins_cer_no) {
		this.ins_cer_no = ins_cer_no;
	}
	...
	public String toString() {
		return "DrClaimsCustomer [id=" + id + ", lid=" + lid + ", companyName=" + companyName
				+ ", companyNameProtocolShow=" + companyNameProtocolShow + ", name=" + name + ", sex=" + sex
				+ ", phone=" + phone + ", certificateType=" + certificateType + ", certificateNo=" + certificateNo
				+ ", mechanismNo=" + mechanismNo + ", industryType=" + industryType + ", businessNo=" + businessNo
				+ ", companyPhone=" + companyPhone + ", companyMail=" + companyMail + ", address=" + address
				+ ", loanUse=" + loanUse + ", bankNo=" + bankNo + ", tableName=" + tableName + ", registerMoney="
				+ registerMoney + ", isExistence=" + isExistence + ", operatingPeriod=" + operatingPeriod
				+ ", mainBusiness=" + mainBusiness + ", user_id=" + user_id + ", fuiou_acnt=" + fuiou_acnt
				+ ", mchnt_txn_ssn=" + mchnt_txn_ssn + ", bank_perm_no=" + bank_perm_no + ", ins_cer_no=" + ins_cer_no
				+ ", updataIdAndAcnt=" + updataIdAndAcnt + ", fileStatus=" + fileStatus + ", fuiouMessageNo="
				+ fuiouMessageNo + ", failureCause=" + failureCause + "]";
	}
