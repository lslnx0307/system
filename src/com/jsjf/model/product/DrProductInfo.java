...
public class DrProductInfo{
	...
	private String remitMchntTxnSsn;//划拨流水 多个之间逗号隔开
	
	private Integer mgid;//会员等级ID
	
	private Integer productMarking;//产品标识
	
	private Integer choose;//选择标识
	...
	private Integer borrowing_type;
	...
	public String toString() {
		return "DrProductInfo [id=" + id + ", fid=" + fid + ", sid=" + sid + ", code=" + code + ", fullName=" + fullName
				...
				+ acceptPic + ", addDate=" + addDate + ", addUser=" + addUser + ", updDate=" + updDate
				+ ", repayTypeName=" + repayTypeName + ", shouldInterest=" + shouldInterest + ", remitMchntTxnSsn="
				+ remitMchntTxnSsn + ", mgid=" + mgid + ", productMarking=" + productMarking + ", choose=" + choose
				+ ", updUser=" + updUser + ", fileStatus=" + fileStatus + ", fuiouMessageNo=" + fuiouMessageNo
				+ ", failureCause=" + failureCause + ", statusName=" + statusName + ", experienceName=" + experienceName
				+ ", typeName=" + typeName + ", surplusDay=" + surplusDay + ", renewal=" + renewal + ", bespoke="
				+ bespoke + ", mappingStatus=" + mappingStatus + ", remainsAmount=" + remainsAmount
				+ ", mappingEndDate=" + mappingEndDate + ", mappingAmount=" + mappingAmount + ", raiseSuccessDate="
				+ raiseSuccessDate + ", mappingCount=" + mappingCount + ", searchStartDate=" + searchStartDate
				+ ", searchEndDate=" + searchEndDate + ", sName=" + sName + ", parentName=" + parentName
				+ ", project_no=" + project_no + ", project_st=" + project_st + ", project_usage=" + project_usage
				+ ", drClaimsPic=" + drClaimsPic + ", drProductPic=" + drProductPic + ", drProductExtend="
				+ drProductExtend + ", loanStatus=" + loanStatus + ", loanName=" + loanName + ", loanCode=" + loanCode
				+ ", atid=" + atid + ", refundStartDate=" + refundStartDate + ", refundEndDate=" + refundEndDate
				+ ", interest=" + interest + ", fullStartDate=" + fullStartDate + ", fullEndDate=" + fullEndDate
				+ ", remainRaiseDay=" + remainRaiseDay + ", actLoanTime=" + actLoanTime + ", startactLoanTime="
				+ startactLoanTime + ", endactLoanTime=" + endactLoanTime + ", loanAmount=" + loanAmount + ", bankNO="
				+ bankNO + ", bankName=" + bankName + ", prizeId=" + prizeId + ", prizeName=" + prizeName
				+ ", mchntTxnSsn=" + mchntTxnSsn + ", interestSuccessTotal=" + interestSuccessTotal
				+ ", interestFailTotal=" + interestFailTotal + ", interestStatus=" + interestStatus
				+ ", repaySuccessTotal=" + repaySuccessTotal + ", repayFailTotal=" + repayFailTotal + ", repayStatus="
				+ repayStatus + ", thaw=" + thaw + ", phone=" + phone + ", tableName=" + tableName + ", itemNo="
				+ itemNo + ", loginId=" + loginId + ", borrowing_type=" + borrowing_type + ", principleId="
