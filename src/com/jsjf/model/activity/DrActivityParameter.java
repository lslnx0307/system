...
public class DrActivityParameter {
	...
	private Integer ahsId;//层级表ID
	private String hierarchicalName;//层级名称
	private String repayType;//还款方式
	private String packetSource;//红包来源
	private String packetRemak;//备注
	...
	public String getPacketRemak() {
		return packetRemak;
	}

	public void setPacketRemak(String packetRemak) {
		this.packetRemak = packetRemak;
	}
	...
	public String toString() {
		return "DrActivityParameter [id=" + id + ", coupons=" + coupons + ", code=" + code + ", name=" + name
				+ ", amount=" + amount + ", raisedRates=" + raisedRates + ", enableAmount=" + enableAmount
				+ ", grantQty=" + grantQty + ", surplusQty=" + surplusQty + ", surplusAmount=" + surplusAmount
				+ ", type=" + type + ", types=" + Arrays.toString(types) + ", applicableScenarios="
				+ applicableScenarios + ", applicableProducts=" + applicableProducts + ", applicableUser="
				+ applicableUser + ", status=" + status + ", deadline=" + deadline + ", addUser=" + addUser
				+ ", addTime=" + addTime + ", updateUser=" + updateUser + ", updateTime=" + updateTime
				+ ", productDeadline=" + productDeadline + ", multiple=" + multiple + ", addName=" + addName
				+ ", usedQty=" + usedQty + ", sendQty=" + sendQty + ", startTime=" + startTime + ", endTime=" + endTime
				+ ", orderAmount=" + orderAmount + ", ahsId=" + ahsId + ", hierarchicalName=" + hierarchicalName
				+ ", repayType=" + repayType + ", packetSource=" + packetSource + ", packetRemak=" + packetRemak
				+ ", updateName=" + updateName + ", statuses=" + Arrays.toString(statuses) + "]";
	}
}