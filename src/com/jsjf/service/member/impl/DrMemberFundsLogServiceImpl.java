...
public class DrMemberFundsLogServiceImpl implements DrMemberFundsLogService {
	...
	public BaseResult getMemberFundsLogList(DrMemberFundsLog drMemberFundsLog, PageInfo pi) {
		...
		map.put("mgid", drMemberFundsLog.getMgid());
		map.put("oneType", drMemberFundsLog.getOneType());
		map.put("twoType", drMemberFundsLog.getTwoType());
		map.put("threeType", drMemberFundsLog.getThreeType());
