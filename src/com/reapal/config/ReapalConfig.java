...
//	//正式环境
//	// 商户ID，由纯数字组成的字符串
//	public static String merchant_id = "100000001300644"; 
//	// 交易安全检验码，由数字和字母组成的64位字符串
//	public static String key = "8dg8g4dc8cac1feg2a919ab0680e8b0cce755e4ce46d2e78701gb2f2237c81a1";
//	// 通知地址，由商户提供
//	public static String notify_url = "http://116.231.156.133:7888/recharge/receiveNotifyRB.do";
//	// 商户私钥
//	public static String privateKey = "/alidata/server/config/rbpro-key/user-rsa.pfx";
//	// 私钥密码
//	public static String password = "N2FZEa";
//	// 融宝公钥 正式环境不用更换
//	public static String pubKeyUrl = "/alidata/server/config/rbpro-key/itrus001.cer";
