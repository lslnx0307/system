...
//	public static String certPath = "/usr/local/tomcat/config/jyt-key/jytpayserver.cer";//证书存放路径
	...
	//正式环境
//	public static String pfxPath = "/alidata/server/config/JSCF.pfx";
//	public static String certPath = "/alidata/server/config/PLATFORM_PUBLICKEY.cer";//证书存放路径
//	private static String certPasswd = "Js20160901";// 证书密码
//	
//	public static String MERCHANT_ID = "290060100045";	//正式环境测试商户		
//	public static String APP_SERVER_URL = "https://www.jytpay.com:9010/JytCPService/tranCenter/encXmlReq.do";	//正式环境
//	public static String PAY_ACCOUNT = "00120000000010002223";//	正式环境代付账号
//	public static String COLLECTION_ACCOUNT = "00120000000010002266";	//正式环境代收账号
//
//	public static String WY_MERCHANT_ID = "290060100045";	//正式环境测试网银商户号
//	public static String WY_KEY = "7239dd4d4fe7cdfc5eaab581545e44ae";	//正式网银充值KEY
//	public static String WY_QUERY_URL = "https://www.jytpay.com:9510/JytNetpay/payment-query.do";//正式网银查询URL
