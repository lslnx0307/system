...
<div class="login-wrap">
	<div class="login-mode">
		<h1 class="logo">
	    	<a href="http://jushengcaifu.com" target="_Blank"><img src="${apppath }/images/login-logo.png" /></a>
	    </h1>
	    ...
	    <div class="login-box">
	    	<form id="loginForm" action="${apppath }/user/doLoginUser.do" id="loginForm"  method="post">
	            ...
	            <div class="code-wrap">
	            	...
	            	<img id="img_rand" src="${apppath }/user/validateCode.do" onclick="this.src=this.src+'?'" />
	            </div>
