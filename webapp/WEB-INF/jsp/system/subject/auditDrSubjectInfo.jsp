	...
	<div title="<center>企业客户基本信息</center>" class="easyui-panel" style="width:100%;height:auto;padding:10px;margin-bottom: 10px" data-options="collapsible:true">
		<table align="center" cellspacing="1" cellpadding="1" style="width:auto;">
			...
			<tr>
					...
					<td>
						<input name="drClaimsCustomer.registerMoney" value="${drClaimsCustomer.registerMoney}" type="text" class="easyui-numberbox" data-options="min:0,max:100000000,"/>
					</td>
	...
	data-options="collapsible:true">
		...
		<table align="center" cellspacing="1" cellpadding="1" style="width:auto;margin-bottom: 10px">
			<tr align="right">
				...
				<td>
						...
						<select name="drClaimsGuarantee[0].pawnWay" value="${v.pawnWay }" style="width: 175px" class="easyui-combobox">
			...
			<tr>
				...
				<td>
					<input name="drClaimsGuarantee[0].companyGuaranteeAmount" type="text" class="easyui-numberbox" data-options="min:0,max:100000000,precision:2"/>
				</td>
			</tr>
			<tr>
		...
		<table align="center" cellspacing="1" cellpadding="1" style="width:auto;margin-bottom: 10px">
			...
			<tr>
				<td align="right">是否有个人担保：</td>
				<td>
					<select name="drClaimsGuarantee[${i.index }].isGuarantee" value="${v.isGuarantee }" style="width: 175px" class="easyui-combobox">
						<c:forEach items="${whether}" var="map">
			...
			<tr>
				<td align="right">是否有公司保证：</td>
				<td>
					<select name="drClaimsGuarantee[${i.index }].isCompanyGuarantee" value="${v.isCompanyGuarantee }" style="width: 175px" class="easyui-combobox">
						<c:forEach items="${whether}" var="map">
			...
			<tr>
				<td align="right">是否有融资性担保：</td>
				<td>
					<select name="drClaimsGuarantee[${i.index }].isFinanc"  value="${v.isFinanc }" style="width: 175px" class="easyui-combobox">
						<c:forEach items="${whether}" var="map">
