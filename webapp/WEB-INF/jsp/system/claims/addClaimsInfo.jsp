		...
		<div title="<center>企业客户基本信息</center>" class="easyui-panel" style="width:100%;height:auto;padding:10px;margin-bottom: 10px" data-options="collapsible:true">
			<table align="center" cellspacing="1" cellpadding="1" style="width:auto;">
				<tr>
					...
					<td colspan="5">
						<input name="drClaimsCustomer.companyName" style="width: 655px" type="text" class="easyui-textbox" data-options="required:true,validType:'maxLength[100]'"/>
					</td>
				</tr>
				<tr>
					<td align="left">注册资金（万元）：</td>
					<td>
						<input name="drClaimsCustomer.registerMoney" type="text" class="easyui-numberbox" data-options="min:0,max:100000000,precision:6"/>
					</td>
					<td align="left">是否存续：</td>
					<td>
						<select name="drClaimsCustomer.isExistence" style="width: 175px" class="easyui-combobox">
					...
					<td>
						<input name="drClaimsCustomer.operatingPeriod" type="text" class="easyui-numberbox" data-options="required:false,min:0,max:100000000"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3">
						<input name="drClaimsCustomer.businessNo" style="width: 415px" type="text" class="easyui-textbox" data-options="validType:'maxLength[100]'"/>
					</td>
				...
				<tr>
					...
					<td colspan="5">
						<input name="drClaimsCustomer.mainBusiness" style="width: 655px" type="text" class="easyui-textbox" data-options="validType:'maxLength[200]'"/>
					</td>
				</tr>
				<tr>
		...
		data-options="collapsible:true,tools:'#shareholderBtn'">
			<table align="center" cellspacing="1" cellpadding="1" style="width:auto;margin-bottom: 10px">
				...
				<tr>
					...
					<td>
						<input name="drClaimsShareholder[0].amountPaidIn" type="text" class="easyui-numberbox" data-options="required:false,min:0,max:100000000,precision:6"/>
					</td>
				</tr>	
			</table>
		</div>
		...
		<div title="<center>融资项目基本信息</center>" class="easyui-panel" style="width:100%;height:auto;padding:10px;margin-bottom: 10px" data-options="collapsible:true">
			<table align="center" cellspacing="1" cellpadding="1" style="width:auto;">
				...
				<tr>
					...
					<td>
						<input id='loanAmount' name="loanAmount" class="easyui-numberbox" data-options="required:true,min:0,max:100000,precision:6"/>
					</td>
					<td align="left">项目融资服务费率(%)：</td>
					<td>
						<input id='serviceRate' name="serviceRate" class="easyui-numberbox" data-options="min:0,max:100,precision:2"/>
					</td>
					<td align="left">项目融资服务费(万元)：</td>
					<td>
						<input id='serviceCharge' name="serviceCharge" class="easyui-numberbox" data-options="required:true,min:0,max:100000000,precision:6" readonly="readonly"/>
					</td>
				</tr>
				<tr>
					<td align="left">币种：</td>
				...
				<tr>
					...
					<td>
						<input id="creditDate" name="creditDate" class="easyui-datebox" data-options="required:true"/>
					</td>
					<td align="left">融资顾问时间结束：</td>
					<td>
						<input id="overDate" name="overDate" class="easyui-datebox" data-options="required:true"/>
					</td>
					<td align="left">融资顾问期限（天）：</td>
					<td>
						<input id='financingDeadline' name="financingDeadline" class="easyui-numberbox" data-options="min:0,max:100000000" data-options="required:true" readonly="readonly"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3">
						<input name="bankNo" style="width:500px" type="text" class="easyui-textbox" data-options="validType:'maxLength[50]',required:true"/>
					</td>
				</tr>
				<tr>
			...
			<table align="center" cellspacing="1" cellpadding="1" style="width:auto;margin-bottom: 10px">
			  <tr align="right">
				...
				<tr>
					...
					<td align="right">个人保证名称：</td>
					<td>
						<input id="guarantee" name="drClaimsGuarantee[0].guarantee" type="text" class="easyui-textbox" data-options="validType:'maxLength[10]'"/>
					</td>
...
<script type="text/javascript">
	//判断担保
		...
		function addDrBillInfo(){
			var serviceCharge = $('#serviceCharge').numberbox('getValue');
