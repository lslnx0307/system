...
<form id="addSysBannerForm" enctype="multipart/form-data">
	<table>
		...
		<tr>
			<td>
				开始时间：
				<input id="startDate" name="startDate" class="easyui-datetimebox" data-options="required:true"/>
				结束时间：
				<input id="endDate" name="endDate" class="easyui-datetimebox" data-options="required:true"/>
			</td>
		</tr>
		<tr>	
			<td>
		...
		<tr>	
			<td>
				跳转地址:
				<input type="text" name="location" class="easyui-textbox"  data-options="required:true"/>
