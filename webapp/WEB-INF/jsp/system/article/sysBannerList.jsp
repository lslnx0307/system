	...
	data-options="singleSelect:true,
	    ...
	    <tr>
	        ...
	        <th data-options="field:'title'" width="10%">广告标题</th>
	       	...
	       	<th data-options="field:'startDate'" formatter="iFormatDateTimeBoxFull">开始时间</th>	     
	       	<th data-options="field:'endDate'" formatter="iFormatDateTimeBoxFull">结束时间</th>	     
	       	<th data-options="field:'codeName'" width="6%" >广告位置</th>	
	       	<th data-options="field:'code'" width="10%" hidden="true"></th>  
...
<script type="text/javascript">
	...
	function deleteSysBanner(index) {
 	...
 	function recoverSysBanner(index) {
	    ...
	    var row = $('#sysBannerList').datagrid('getSelected'); 
		$.ajax({
	       	url: "${apppath}/banner/recoverSysBanner.do?id="+row.id+"&code="+row.code,
	        type: 'POST',
	        success:function(result){
				if(result.success){
					$.messager.alert("提示信息",result.msg);
