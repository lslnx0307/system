...
<body>
	...
	<div id="addDrCpaInfoDialog" class="easyui-dialog" title="生成链接"
		data-options="iconCls:'icon-edit',closed:true,modal:true,minimizable:false,resizable:true,maximizable:false,buttons:'#addDrCpaInfoBtn'" style="width:500px;height:300px;padding:5px;">
		<form id="addDrCpaInfoForm">
			<table align="center">
				...
				<tr>
					...
					<td>
						<select  id="otherParam" name="status" class="easyui-combobox">
							<option value='0'>无</option>
							<option value='1'>H5</option>
							<option value='2'>PC</option>
							<option value='3'>H5(下载APP)</option>
         		  		</select>
					</td>
				</tr>
				<tr>
	...
	$(document).ready(function() {
		...
		$("#otherParam").combobox({
			...
			onChange : function(n, o) {
				...
				if (n == "1") {
					$("#parameters").textbox("setValue", "wap=true");
				}else if(n == "3"){
					$("#parameters").textbox("setValue", "wap=true&appid=");
				}else{
