	...
	<table id="incrRestList" title="加息券管理" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'hierarchicalName'" width="6%">加息劵层级分类</th>
	...
	<div id="addIncrRestDialog" class="easyui-dialog" title="新增加息券"
		...
		<form id="addIncrRestForm">
			<table align="center">
				...
				<td style="width:100px"  >加息劵来源:</td>
					<td   >
						<input type="text" id="packetSource" name="packetSource" class="easyui-textbox" data-options="precision:2,groupSeparator:','," />
					</td>				
				<tr>
