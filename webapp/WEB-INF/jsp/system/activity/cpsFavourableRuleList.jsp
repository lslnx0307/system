			...
			<table align="center">
				...
				<tr>
					...
					<td><select id="isFirst" name="isFirst" style="width:150px" class="easyui-combobox" data-options="required:true">
							<option value='3' selected="selected">不区分</option>
							<option value='1'>是</option>
							<option value='0'>否</option>
						</select>
					</td>
				...
				<tr>
					<td>红包2：</td>
					<td>
						<select id="addCouponType2" name="activityId_2" style="width:150px;">
							<option value="" >-请选择-</option>
						</select>
				</tr>
				<tr>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#addCouponType1").combogrid({
		     	panelWidth:460,
		     	url:'../activity/drActivityByCouponTypeList.do?scene=1&types=1,2,5',
		     	idField:'id',    
    			textField:'name',
		       	columns:[[    
		...
		function updateStatus(id){
			 $.messager.confirm('操作提示', '确定要修改状态吗?', function(data){
				 if(data){
					$.ajax({
