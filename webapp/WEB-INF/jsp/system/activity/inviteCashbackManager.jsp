...
<body>
	...
	<div id="addActivity" class="easyui-dialog" style="height:70%;width:40%" closed="true"	buttons="addBtn"  data-options="resizable:true,modal:true,closed:true">
		...
		<div style="padding:5px;">
			...
			奖励发放:<select id="addType" name="type"  class="easyui-combobox"  size="15" style="width:150px">
				<option value='1' selected="selected">系统自动发放</option>
				<option value='0' >客户自己领取</option>
			</select>
		</div>
		<div style="padding:5px">
	...
	<div id="viewActivity" class="easyui-dialog" style="height:70%;width:40%" closed="true"	buttons="addBtn"  data-options="resizable:true,modal:true,closed:true">
		...
		<div style="padding:5px;">
			...
			奖励发放:<select id="viewtype" name="type"  class="easyui-combobox" disabled="true"   size="15" style="width:150px">
				<option value='1' selected="selected">系统自动发放</option>
				<option value='0' >客户自己领取</option>
			</select>
		</div>
		...
		function view(index){
			...
			if(rows.length>0){
				...
				if(row != null) { 
					...
					$('#viewtype').combobox('select',row.type);
					id=row.id;
					//加载产品表
