	    	...
	    	<table align="center">
				...
				<tr style="width:400px;hight:400px">
					...
					<td colspan="3" rowspan="4">
						<textarea id="packetRemak"style="width:300px;height:40px;" name="packetRemak" type="text" value="${drActivityParameter.packetRemak}" readonly="readonly"></textarea>
					</td>
				</tr>
			</table>
		</form>
...
<script type="text/javascript">
	$(document).ready(function(){
		getThreeFlag();//页面加载完成的时候触发层级类型查询
		$('#packetRemak').val("${drActivityParameter.packetRemak}");//给<textarea>赋默认值
	});
	//关闭窗口
