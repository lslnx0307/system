		...
		<table id="drMemberList" class="easyui-datagrid"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'initLevel'" width="6%">初始会员等级</th>
					<th data-options="field:'levelName'" width="6%">当前会员等级</th>
					<th data-options="field:'wealth'" width="6%">财富值</th>
					<th data-options="field:'isMember'" width="6%" formatter="formatterIsMember">是否点亮</th>
					<th data-options="field:'newAmount'" width="6%" styler="styleColor">新累计投资总额</th>
					<th data-options="field:'surplusAmount'" width="6%" styler="styleColor">剩余投资总额</th>
		...
		<table id="beInvited" title="用户好友情况 <span style='color: #0015FF;'>推荐人手机：</span><span id='referrerMemberPhone' style='color: blue;'></span><span style='color: #0015FF;'>推荐人姓名：</span><span id='referrerMemberName' style='color: blue;'></span>" class="easyui-datagrid"
		    ...
		    <thead>
				<tr>
					...
					<th data-options="field:'recommCodes'"  width="10%">被邀请人推荐码</th>
...
<script type="text/javascript">
	...
	//给状态改变背景色
		...
		//删除
	 	...
	 	//是否点亮操作formatterIsMember
		function formatterIsMember(val,row,index){
			if(row.isMember==1){
				return "已点亮";
