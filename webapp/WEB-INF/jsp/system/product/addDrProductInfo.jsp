		...
		<div title="产品信息" class="easyui-panel" style="width:100%;height:auto;padding:10px;margin-bottom: 10px">
			<table id="productInfo" align="center" cellspacing="1" cellpadding="1" style="width:auto;">
				...
				<tr>
					...
					<td>会员等级：</td>
					<td><select id="mgid" name="mgid" style="width: 172px" class="easyui-combobox">
...
<script type="text/javascript">
	...
	$("#sid").combobox({    
 	...
 	function addDrProductInfo(){
		...
		if($("#productType").combobox('getValue') ==6 && $("#mgid").combobox('getValue')==''){
		...
		$.ajax({
			...
			success:function(result){
				if(result.success){
					...
					$("#productMarking").combobox('select',result.map.drProductInfo.productMarking);
