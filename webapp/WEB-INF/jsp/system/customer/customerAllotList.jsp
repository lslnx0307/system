	 ...
	 <!--        最后沟通时间:<input class="easyui-datebox" id="lastcall" name="lastcall" style="width:100px"/> -->
  		...
  		<!--  -->
         	...
         	<br>	
	  		...
	  		沟通次数:<input id="callNumAgo" name="callNumAgo"   class="easyui-numberbox"  size="15" style="width:100px"/>
	  				-<input id="callNumAfter" name="callNumAfter"  class="easyui-numberbox"  size="15" style="width:100px"/>
	  		投资次数:<input id="investCountFirst" name="investCountFirst" class="easyui-numberbox" style="width:140px"/>
	    			-<input id="investCountEnd" name="investCountEnd" class="easyui-numberbox" style="width:140px"/>
