...
<body>
	...
	style="height:99%;width:99.9%">
	    ...
	    <tr>
	        ...
	        <th data-options="field:'mobilePhone',align:'center'" width="auto">用户</th>	        
	        <th data-options="field:'regdate',align:'center'" width="auto" formatter="iFormatDateBoxFull">注册时间</th>
	        <th data-options="field:'mchnt_txn_ssn',align:'center'" width="auto" >绑卡时间</th>
	        <th data-options="field:'calldate',align:'center'" width="auto" formatter="iFormatDateBoxFull">外呼时间</th>
...
<script type="text/javascript">
	...
	var searchBudgetList = function(){
 		$('#activityBudgetList').datagrid({
 			url:"${apppath}/membercall/tiedCard.do",
 			fitColumns : true,
 			showFooter:true,
 			pagination : true,
 			rownumbers:true,
