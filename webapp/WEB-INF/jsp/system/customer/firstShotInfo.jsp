...
<body>
	<table id="activityBudgetList" title="首投明细 " 
	style="height:99%;width:99.9%">
		<thead>
	    <tr>
	    	<!-- <th data-options="field:'id'" hidden="true"></th> -->
	    	<th data-options="field:'allot'" width="auto">部门</th>
	        <th data-options="field:'stid'" width="auto">投资序列号</th>
	        ...
	        <th data-options="field:'type',align:'center'" width="auto">渠道类型</th>
	        ...
	        <th data-options="field:'calldate',align:'center'" width="auto" formatter="iFormatDateBoxFull">沟通时间</th>
...
<script type="text/javascript">
	...
	var searchBudgetList = function(){
 		$('#activityBudgetList').datagrid({
 			url:"${apppath}/membercall/firstShotInfo.do",
 			fitColumns : true,
 			showFooter:true,
 			pagination : true,
 			rownumbers:true,
