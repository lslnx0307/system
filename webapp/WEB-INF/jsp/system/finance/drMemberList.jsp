...
<script type="text/javascript">
	...
	$(function(){
		$("#${tabid} #memberList").datagrid({
			...
			columns:[[
				...
				{title:"会员等级",field:"levelName",width:$(this).width() * 0.05,align:"left"},
				{title:"财富值",field:"wealth",width:$(this).width() * 0.05,align:"left"},
				...
				{	title:"操作",
					...
					formatter:function(value,row,index){
						...
						if(row.isFuiou ==1 && row.updateStatus !="待审核"){
							operates += "<a href='#' class='btn l-btn l-btn-small' onclick=\"updateCardNo(\'"+row.phone+"')\">修改银行卡号</a>  ";
						}
	...
	function updateCardNo(mobilephone){
